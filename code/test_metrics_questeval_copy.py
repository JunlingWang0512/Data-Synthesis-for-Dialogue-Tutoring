...
file_path = '/cluster/scratch/wangjun/keyword+post_flan-t5-xl_result/business_search_output_post.json'
...
import os
OUTPUT_FILE = '/cluster/home/wangjun/dialog_inpainting/dialog_inpainting_implementation/code/output/8_24_questeval/flant5xl_business_questeval.csv'
SAVE_INTERVAL = 10
