...
file_path = '/cluster/scratch/wangjun/Student_question_result/math_student_search_output.json'
...
import os
OUTPUT_FILE = '/cluster/home/wangjun/dialog_inpainting/dialog_inpainting_implementation/code/output/8_16_qfactscore_calculation/filter_compare/flant5xl_math_metrics_before_post_student.csv'
SAVE_INTERVAL = 10
