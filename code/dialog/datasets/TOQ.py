...
class QRECC(DocumentGroundedDataset, datasets.GeneratorBasedBuilder):
    ...
    _URL = '/cluster/scratch/wangjun/local_data/combine_TOQ'
...
# one turn have both question and answer
    ...
    def _split_generators(self, dl_manager):  # junling modify done 
        ...
        file_names = ["TOQ_filtered_combined_train.json", "TOQ_filtered_combined_val.json", "TOQ_filtered_combined_test.json"]
        data_files = {   
