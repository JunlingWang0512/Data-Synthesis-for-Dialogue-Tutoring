...
# Load Data
with open('/cluster/scratch/wangjun/keyword+post_flan-t5-xl_result/math_chatbot_train.json', 'r') as file:
    data = json.load(file)

source_texts = [entry['question'] for entry in data]
target_texts = [entry['answer'] for entry in data]
...
PROMPT = "Assume you are a teacher, please answer this question from your student:"
...
training_args = TrainingArguments(
    ...
    num_train_epochs=10,
    logging_dir="/cluster/scratch/wangjun/chatbot/log",
    output_dir="/cluster/scratch/wangjun/chatbot/output",
...
model_save_path = "/cluster/scratch/wangjun/chatbot/model/model_1"
