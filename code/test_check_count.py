...
# file_path = '/cluster/scratch/wangjun/dialogue_inpainting5_18_flan_lora_xl/work/ukp/huggingface/7_10_science_search/HuggingfaceSearchJob.8FtuwoC7t0JX/output/search_output.json'
...
#         score_dict['Q_A_eval'] = Q_A_eval(tuple_[0],tuple_[1],sentences)
...
# print(df)
# df.to_csv('7_10_science_search_metrics.csv')


# #####################################################################
# file_path = '/cluster/scratch/wangjun/dialogue_inpainting5_18_flan_lora_xl/work/ukp/huggingface/7_10_science_search/HuggingfaceSearchJob.8FtuwoC7t0JX/output/search_output_post.json'
...
# print(df)
# df.to_csv('7_10_science_search_post_metrics.csv')

###############################################################################################
# file_path = '/cluster/scratch/wangjun/dialogue_inpainting5_18_flan_lora_xl/work/ukp/huggingface/7_10_social_search/HuggingfaceSearchJob.8FtuwoC7t0JX/output/search_output.json'
...
# print(df)
# df.to_csv('7_10_social_search_metrics.csv')

########################################################33
# file_path = '/cluster/scratch/wangjun/dialogue_inpainting5_18_flan_lora_xl/work/ukp/huggingface/7_10_social_search/HuggingfaceSearchJob.8FtuwoC7t0JX/output/search_output_post.json'
...
# print(df)
# df.to_csv('7_10_social_search_post_metrics.csv')

################################################################
# file_path = '/cluster/scratch/wangjun/dialogue_inpainting5_18_flan_lora_xl/work/ukp/huggingface/7_10_keyword_science_search/HuggingfaceSearchJob.8FtuwoC7t0JX/output/search_output.json'
...
# print(df)
# df.to_csv('7_10_NO_TOXICITY_keyword_science_search_metrics.csv')

# ################################################################
# file_path = '/cluster/scratch/wangjun/dialogue_inpainting5_18_flan_lora_xl/work/ukp/huggingface/7_10_keyword_science_search/HuggingfaceSearchJob.8FtuwoC7t0JX/output/search_output_post.json'
...
# print(df)
# df.to_csv('7_10_NO_TOXICITY_keyword_science_search_post_metrics.csv')
# ################################################################
# file_path = '/cluster/scratch/wangjun/dialogue_inpainting5_18_flan_lora_xl/work/ukp/huggingface/7_10_keyword_social_search/HuggingfaceSearchJob.8FtuwoC7t0JX/output/search_output.json'
...
# print(df)
# df.to_csv('7_10_NO_TOXICITY_keyword_social_search_post_metrics.csv')