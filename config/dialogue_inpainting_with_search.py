...
async def task_arithmetic():
    config = {
        ...
        "num_expert_epochs": 5,
        "gpu_mem_fisher": 10,
        "baseline_model_name_or_path":'/cluster/scratch/wangjun/dialogue_inpainting5_6_both/work/ukp/huggingface/training/HuggingfaceTrainingJob.5NJi2znCfmgw/output/models/epoch-best'
    }
# "train[:20%]",
    run_models(**config)
